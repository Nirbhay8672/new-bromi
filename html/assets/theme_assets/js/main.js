...
(function ($) {
  ...
  if (hash) {
    const tabElement = document.querySelector('.ap-tab-main a[href="#' + hash + '"]');
    if (tabElement) {
  ...
  /* Slick Slider */
  $(".banner-slider, .slick-slider").each(function () {
    $(this).slick({
  ...
  $('a[data-bs-toggle="tab"], a[data-bs-toggle="pill"]').on("shown.bs.tab shown.bs.pill", function () {
  ...
  /* Carousel */
  const carouselElement = document.getElementById('myCarouselArticle');
  if (carouselElement) {
  ...
  /* Modal reload active - REMOVED auto-show to prevent modals from opening on page load */
