(function ($) {
    ...
    // Initialize popovers with Bootstrap 5 native API
    const popoverTriggerList = document.querySelectorAll('.btn-popover');
    ...
    const placementPopoverTriggerList = document.querySelectorAll('.btn-placement');
    placementPopoverTriggerList.forEach(popoverTriggerEl => {
        new bootstrap.Popover(popoverTriggerEl, {
            trigger: 'focus',
            template: popover,
            html: true,
